...
private:
	...
	static short _ReadMainMenuOption() {
		...
		cout << setw(40) << left << "" << "Enter your option [1/9] : ";
		userOption = clsInputValidate::readShortNumberBetween(1, 9, "\t\t\t\t\tInvalid number! Please enter a valid number: ");
		return userOption;
	}
