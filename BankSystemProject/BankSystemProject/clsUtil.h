...
public:
    ...
    static string numberToText(long number)
    {
        ...
        // 2000000000 to 9999999999
        else if (number >= 2000000000 && number <= 9999999999)
        {
            return numberToText(number / 1000000000) + "Billions " + numberToText(number % 1000000000);
        }
        // 1000000000000 and above
        else
        {
            return numberToText(number / 1000000000) + "Trillions " + numberToText(number % 1000000000000);
        }
    }
};
